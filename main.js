...
function my_keydown(e) {
	...
	console.log(keyPressed);
		...
		if ((keyPressed >= 0 && keyPressed <= 16) || (keyPressed >= 19 && keyPressed <= 26) || (keyPressed >= 28 && keyPressed <= 36) || (keyPressed >= 41 && keyPressed <= 47) || (keyPressed >= 58 && keyPressed <= 64) || (keyPressed >= 91 && keyPressed <= 96)) {
			otherkey();
